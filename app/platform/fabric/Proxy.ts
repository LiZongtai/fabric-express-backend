 ...
 */
 export class Proxy {
	...
	async networkList() {
		...
		console.debug('networkList >> %s', response);
		return response;
	}
/**
	 *
 ...
 async getCurrentChannel(network_id) {
    console.debug('getCurrentChannel: network_id', network_id);
    ...
    console.debug('getCurrentChannel >> %j', respose);
    return respose;
}
...
async getPeersStatus(network_id, channel_genesis_hash) {
    ...
    if (client.status) {
        try {
            ...
            console.debug('getPeersStatus >> ', e);
        }
    }
    ...
    console.debug('getPeersStatus >> %j', peers.length);
    return peers;
}
...
async getChannelsInfo(network_id) {
    ...
    console.debug('getChannelsInfo >> %j', currentchannels);
...
async getChannels(network_id) {
    ...
    console.debug('getChannels >> %j', respose);
    return respose;
}
